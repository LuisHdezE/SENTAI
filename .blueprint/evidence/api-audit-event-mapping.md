...
| API-ADM-002..004 | CRUD User | CANONICAL_EVENT | `admin.user.created` / `updated` / `disabled` | success | same TX | ACT-007 | YES | conditional | RESOLVED | Security. |
| API-ADM-005..006 | Manage Roles | CANONICAL_EVENT | `authz.role.assigned` / `revoked` | success | same TX | ACT-007 | YES | conditional | RESOLVED | Security. |
...
| API-INV-001..002 | Receive / Put-away | CANONICAL_EVENT | `inventory.asn.received` / `putaway.completed` | success | same TX | ACT-002 | YES | conditional | RESOLVED | Mutation. |
...
| API-INV-006..007 | Block / Unblock | CANONICAL_EVENT | `inventory.location.blocked` / `unblocked` | success | same TX | ACT-003 | YES | conditional | RESOLVED | Mutation. |
...
| API-FIN-002..003 | Payment | CANONICAL_EVENT | `finance.payment.registered` / `applied`, and conditionally `finance.obligation.closed` | success | same TX | ACT-006 | YES | conditional | RESOLVED | `finance.obligation.closed` conditional if paid in full. |
